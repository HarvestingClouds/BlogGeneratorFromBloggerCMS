            ...
            <div class="col-lg-12">
                ...
                <div class="content">
                    <form action="<?php echo $root; ?>/update_post/<?php echo $id; ?>" class="form-horizontal" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-8">
                                <label for="dated">Post Date (DD-MM-YYYY)</label>
                                <input required type="text" id="title" name="dated" class="form-control" value="<?php echo date('d-m-Y', strtotime($data['dated'])); ?>">
                            </div>
                        </div>
